...
def generator_model():
    ...
    result = layers.Dense(7**2 * 256, use_bias=False)(result)
    ...
    return models.Model(inputs=[entree_bruit, entree_classe], outputs=sortie)

def discriminator_model():
    entree_image =layers.Input(shape=(28, 28, 1), dtype='float32')
    entree_classe=layers.Input(shape=(10),        dtype='float32')

    result1 = layers.Dense(28**2, use_bias=False)(entree_classe)
    ...
    return models.Model(inputs=[entree_image, entree_classe], outputs=sortie)
